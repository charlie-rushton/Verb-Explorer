...
function getLevelQuestions() {
    ...
    xmlhttp.open("POST", "get_questionsW.php", true);
...
function renderTextInput() {
    ...
    ctx.fillText("Cyflwyno", submitButton.left + 100 / 2, submitButton.top + 5);
...
function renderTopBar() {
    ...
    ctx.fillStyle = "white";
    ctx.textAlign = "left";
    ctx.fillText("Lefel " + levelNumber, 5, 5);

    ctx.font = "30px cymraeg";
    ctx.fillStyle = "white";
    ctx.textAlign = "right";
    ctx.fillText("Sgôr: " + score, canvas.width - 5, 5);
}
...
function renderQuestionBar() {
    ...
    ctx.fillStyle = "white";
    ctx.textAlign = "center";
    ctx.fillText("Cwestiwn " + questionNumber, canvas.width / 2, 70);
...
function renderTimer() {
    ...
    ctx.fillStyle = "white";
    ctx.textAlign = "center";
    ctx.fillText("Amser ar ôl: " + time.toFixed(0), canvas.width / 2, 150);
}
...
function renderLives() {
    ...
    ctx.fillStyle = topBarColor;
    ctx.beginPath();
    ctx.moveTo(canvas.width - 250, barTop);
    ctx.lineTo(canvas.width - 250, barTop + barHeight);
    ctx.lineTo(canvas.width - 280, barTop);
    ctx.fill();
    ctx.fillRect(canvas.width - 250, barTop, 250, barHeight);
    ctx.font = "24px cymraeg";
    ctx.fillStyle = "white";
    ctx.textAlign = "left";
    ctx.fillText("Bywydau: ", canvas.width - 250, barTop);
...
function showLevelScreen() {
    ...
    ctx.fillText("Lefel " + levelNumber, canvas.width / 2, canvas.height / 2);
}
