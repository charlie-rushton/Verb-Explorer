...
//Based on work by: Sam Bentley, Natasha Finney
...
var brandColor = "#461964";
var topBarColor = "#71587E"
var questionBarColor = "#26013c";
...
function addNameInputEventListeners() {
    canvas.addEventListener('click', function (event) {
        ...
        if (y > continueButton.top && y < continueButton.top + continueButton.height
            ...
            console.log(name);
            if (avatarDir === "" || name === "") {
                //alert("Please select an avatar and input your name.");
                console.log("ALERTED");
            }
            else {
                startGame();
...
function renderNameInputButtons() {
    ctx.globalAlpha = 1;
...
function addAvatars() {
    var imgs = ['faceAvatars/avatar1.JPG', 'faceAvatars/avatar2.JPG', 'faceAvatars/avatar3.JPG', 'faceAvatars/avatar4.JPG', 'faceAvatars/avatar5.JPG', 'faceAvatars/avatar6.JPG', 'faceAvatars/avatar7.JPG', 'faceAvatars/avatar8.JPG', 'faceAvatars/avatar9.JPG', 'faceAvatars/avatar10.JPG',];
